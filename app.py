...
# 2. SOAL & KUNCI
  ...
  if st.button("🚀 Buat Paket Soal & Kunci", type="primary"):
...
st.markdown(
    """
    <div class="footer">
        <p>Sistem Akademik | Developed by <b>Zeeo</b><br>WhatsApp: <a href="https://wa.me/6282371729760" target="_blank">082371729760</a><br>© 2026 All Rights Reserved</p>
    </div>
    """,
    unsafe_allow_html=True,
)
